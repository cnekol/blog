...
title: 无用之技 —— NAS
date: 2017-04-15
description: 自年前出于兴趣着手研习至今，已有两三月。成果虽是有，却或多或少去想自身是否又学到一技无用
---
...
- **关于 _NAS_ 系统的选择，其实很多。以下罗列出一些我在探索过程中认为可用性相对较高的部分 _NAS_ 系统：**
  ...
  （群晖官方系统，在非官方硬件跑 DSM 称作 黑群辉 ） 2. **FreeNAS**
  （基于 Freebsd 系统的开源 NAS 系统，功能强，界面设计挺帅，但硬件要求高） 3. **Openmediavault**
  （字义为开源媒体仓库，由原 FreeNAS 核心成员 Volker Theile 发起的基于 Debian 系统开发的开源 NAS，主要面向家庭及小型办公环境） 4. **EasyNAS**
